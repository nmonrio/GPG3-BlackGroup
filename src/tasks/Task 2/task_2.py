...
def print_actions():
    print("The velocity was unchanged during this whole process. ")
    for i in range(len(actions)):
        print("You have",actions[i],end="\n")

def movement(length):
    gpg.drive_cm(length)
    actions.append("The robot moved",i,"cm.")

def turn(i):
    gpg.turn_degrees(i)
    actions.append("The robot turned",i,"degrees")

def orbit(n, m):
    gpg.orbit(n, m)
    actions.append("The robot has orbited",n,"degrees over an arch of radius",m,"cm.")
# Drawing a square:
